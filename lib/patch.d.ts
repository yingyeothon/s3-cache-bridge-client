...
export default function patch(env: Env): <T>(key: string, modRequest: JSONModificationRequest, { noLock, sync, fetch, }?: LockOptions & SyncOptions & FetchOptions) => Promise<T | null>;
